...
//  UnitTesting
//
//  Created by Alexander Blokhin on 10.03.16.
...
class ViewController: UIViewController {
    ...
    @IBAction func numberValueChanged(sender: AnyObject) {
        ...
        let result = percentage(numberSlider.value, percentageSlider.value)
        updateLabels(numberSlider.value, nil, result)
    }
    ...
    @IBAction func percentageValueChanged(sender: AnyObject) {
        ...
        let result = percentage(numberSlider.value, percentageSlider.value)
        updateLabels(nil, percentageSlider.value, result)
    }
